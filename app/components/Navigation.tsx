      ...
      >
        <nav 
          className={`pointer-events-auto transition-all duration-700 ease-[0.22,1,0.36,1] flex items-center justify-between w-full ${
            isScrolled 
              ? 'bg-white/90 dark:bg-[#0A0A0A]/80 backdrop-blur-2xl border border-gray-200/50 dark:border-white/10 max-w-5xl rounded-2xl sm:rounded-full px-6 py-3 sm:py-4 shadow-2xl'
          ...
          >
            ...
            <div className="absolute top-6 left-6 right-6 flex justify-between items-center">
              <a href="#home" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3">
                 <img src="/logotr.png" alt="Triplora" className="w-8 h-8" />
