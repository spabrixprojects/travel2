              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="relative border-b border-white/20 pb-2 group">
                  ...
                  >
                    ...
                    <option value="golden-triangle" className="text-gray-900">Golden Triangle</option>
                    <option value="kerala" className="text-gray-900">Kerala</option>
                    <option value="himalayan" className="text-gray-900">Himalayas</option>
                    <option value="custom" className="text-gray-900">Custom Request</option>
                  </select>
